<table align="center" cellspacing="0" cellpadding="0"><tr>
	<td class="leftalign">
		...
		<!--
		<ul type="square">
				<li>Простой <a href="/gmail/">вход в Gmail</a></li>
				<li>Программа <a href="/timus/">Timus Task Filter</a></li>
				<li>Генератор <a href="/unique/">обзывательств</a></li>
				<li>Чьи-то <a href="/soft/">программы</a></li>
				<li>Просто <a href="/phx/">фотографии</a></li>
				<li>Точное <a href="/clock/">время сервера</a></li>
		</ul>
		-->
		...
		<ul>
			<li>
				Work projects:
				<ul>
					<li><a href="http://www.jetbrains.com/idea/">IntelliJ IDEA</a> &mdash; allegedly the best Java IDE which I'm striving to improve further at JetBrains</li>
					<li>****** &mdash; yet-to-be-opensourced tool I've contributed to at Facebook</li>
			...
			<li>
				University projects:
				<ul>
					<li>Virtual Barbershop &mdash; a webapp prototype we've put together for the Information Systems course</li>
